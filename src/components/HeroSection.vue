            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        I am a skilled full-stack developer with 3 years of experience specializing in Laravel for backend 
                        development and Vue.js for creating dynamic, responsive front-end applications. I have a strong
                         background in building scalable web applications, developing RESTful APIs, and managing databases.
                          With expertise in both frontend and backend, I excel in creating seamless user experiences by integrating 
                          Vue.js with Laravel. I am proficient in modern tools like Tailwind CSS, Git, and Docker,
                         and thrive in collaborative environments, delivering clean, efficient code and innovative solutions.
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <button class="px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <a href="#contact">
                                <span class="relative flex items-center justify-center text-white" onclick="scrollToSection('#contact')">Hire Me</span>
                            </a>
                        </button>
