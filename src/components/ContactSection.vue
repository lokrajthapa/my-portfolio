<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Hi there! I'm Lokraj, a Laravel and Vue.js developer with 4+ years of experience building dynamic and efficient web applications. I’m always excited to connect with fellow professionals, collaborate on projects, and explore new opportunities. Let's connect and discuss how we can work together!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>Email</h4>
                            <p>lokrajthapamagar7@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>https://www.linkedin.com/in/lokraj-thapa-8b3581244/</p>
                        </div>
                    </div>
                </div>
            </div>
