...
const services =ref([
   {
        ...
        description:'A skilled frontend developer proficient in HTML, CSS, JavaScript, Vue.js, and React.js, crafting dynamic, responsive web interfaces. Experienced in building seamless user experiences with modern frameworks and technologies.'
    },
    {
        id:2,
        icon:'https://img.icons8.com/ios-filled/100/ffffff/google-code.png',
        name:'Backend Development',
        description:'A backend developer with 4 years of experience in Laravel, proficient in advanced concepts like job queues, event broadcasting, and API development with Laravel Sanctum. Expert in optimizing database queries with Eloquent, managing complex relationships, and implementing RESTful services'
    },
 
    {
        ...
        description:'A full-stack developer with 4 years of experience, proficient in HTML, CSS, JavaScript, Vue.js, React.js, and Laravel. Skilled in advanced backend concepts like job queues, event broadcasting, API development with Laravel Sanctum, and crafting dynamic, responsive frontends for seamless user experiences.'
    },
    // {
    //     id:4,
